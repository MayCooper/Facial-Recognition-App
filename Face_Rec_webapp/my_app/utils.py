...
haar = cv2.CascadeClassifier(r"W:\MayCooperStation\New Documents\Data Science and ML\FacialRecognition\Face_Rec_webapp\model\haarcascade_frontalface_default.xml")
# pickle files
...
def pipeline_model(path,filename,color='bgr'):
    ...
    cv2.imwrite(r'W:\MayCooperStation\New Documents\Data Science and ML\FacialRecognition\Face_Rec_webapp\static\predict\{}'.format(filename),img)
